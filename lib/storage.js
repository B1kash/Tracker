...
export async function updatePassword(data) {
  return await apiCall('/auth/password', 'PUT', data);
}

export async function togglePrivacy() {
  return await apiCall('/auth/privacy', 'PUT');
}
...
export async function generateDailyRoutineWithAI(prompt, date) {
  return await apiCall('/ai/daily-routine', 'POST', { prompt, date });
}
